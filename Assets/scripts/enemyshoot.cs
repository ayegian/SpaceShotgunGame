...
public class enemyshoot : MonoBehaviour
{
    ...
    public IEnumerator WaittoShoot()
    {
        ...
        {
            this.transform.eulerAngles = new Vector3(this.transform.eulerAngles.x, this.transform.eulerAngles.y, (this.transform.eulerAngles.z - 60));
            for (int i = 0; i<numbullets; i++)
            {
                shoot();
                yield return new WaitForSeconds(.3f);
                this.transform.eulerAngles = new Vector3(this.transform.eulerAngles.x, this.transform.eulerAngles.y, (this.transform.eulerAngles.z + (120/numbullets)));
            }
    ...
    private void shoot()
    {
        ...
        else if (this.gameObject.CompareTag("machinegunguy"))
        {
            ...
            laserrb = beam.GetComponent<Rigidbody2D>();
